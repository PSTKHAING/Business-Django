...
urlpatterns = [
    ...
    path('otp/<str:email>/',auth_view.OTP),
    path('agreement/',page_view.Agreement),
    path('otp/<str:email>/resend/',auth_view.ResendOTP),
    path('confirm_email_to_reset_password/',auth_view.ConfirmEmailToResetPassword),
    path('reset_password/<str:email>/<uuid:reset_id>/',auth_view.ResetPassword),
